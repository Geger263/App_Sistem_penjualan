...
public class Controller_BuktiPesan {
    ...
    //===========================combo pelanggan==============================   
    //memanggil method isicombopelanggan pada DAO_BuktiPesan
    ...
    //memanggil method getkdplg pada DAO_BuktiPesan    
    ...
    public void cetak(){
        try{
            ...
            //cetak ke pdf
            OutputStream output = new FileOutputStream(new File("E:/BuktiPesan"+(form.getTxtnobp().getText())+ ".pdf")); 
            JasperExportManager.exportReportToPdfStream(print, output); 
            
            //cetak ke excel
            File xlsx = new File("E:/BuktiPesan"+(form.getTxtnobp().getText())+ ".xlsx");           
