...
public class Controller_LapPelanggan {
    ...
    public void cetak_preview(){
      try{
          ...
          String path = "src/Report/RepLapPelanggan.jasper";                                
    ...
    public void cetak_excel(){
        try{
            Connection conn = Koneksi.Database.KoneksiDB();
            String path = "src/Report/RepLapPelanggan.jasper";  
            File xlsx = new File("E:/LapPelanggan.xlsx");             
            ...
            JOptionPane.showMessageDialog(null,"Cek file pada drive E:/LapPelanggan.xlsx");
